...
perfect_10_recipe = {:almond_flour => "2 cups", :gluten_freewhole_oats => "1 cup", :kosher_salt => "1/2 teaspoon", :baking_powder => "1/2 teaspoon", :baking_soda => "1/4 tea spoon", :Xanthan_gum => "1/2 teaspoon", :lightly_toasted_slivered_almonds => "1/4 cup", :mini_dark_chocolate_chips => "3/4 cup", :olive_oil => "1/2 cup", :agave => "1/4 cup"}
...
def amount_of_chocolate_chips(perfect_10_recipe)
  return perfect_10_recipe.value(:mini_dark_chocolate_chips)
end
...
def ingredients_and_amounts(perfect_10_recipe)
  perfect_10_recipe.each_pair do |key, value|
    puts "Ingredient: #{key} Amount: #{value}"
  end
end
